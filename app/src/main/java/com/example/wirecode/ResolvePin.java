...
public class ResolvePin extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fragment_add_mapping);
    ...
    public String pin_mapping (byte[] buffer) {
         ...
         //todo: get user to create their own hasmaps then => save to library
         Map<Integer, String> pinmap1 = new HashMap<Integer, String>();
         pinmap1.put(22, "OUTPUT 1N");
        pinmap1.put(23, "OUTPUT 1B");

        pinmap1.put(24, "OUTPUT 2N");
        pinmap1.put(25, "OUTPUT 2B");

        pinmap1.put(26, "OUTPUT 3N");
        pinmap1.put(27, "OUTPUT 3B");

        pinmap1.put(28, "OUTPUT 4N");
        pinmap1.put(29, "OUTPUT 4B");

        pinmap1.put(30, "OUTPUT 5N");
        pinmap1.put(31, "OUTPUT 5B");

        return pinmap1.get(pin_value);
    }
